...
def draw(image, r, theta, line_thickness=2, line_color=(255, 101, 35)):
    ...
    line_color_bgr = (line_color[2], line_color[1], line_color[0])  # BGR format for OpenCV
...
def superm2(image):
    ...
    # Verify the detected line of symmetry
    ...
    for line in lines:
        p0, p1 = line
        cv2.line(image, p0, p1, (0, 255, 0), 2)  # Draw the detected lines in green
